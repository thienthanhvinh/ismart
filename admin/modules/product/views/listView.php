    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form action = "?mod=product&action=list" method="POST"  class="form-s fl-right">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tbody-thumb" style="width: 85px; height: auto">
                                    ...
                                    <td><span class="tbody-text"><?php echo get_outstanding_name($item['outstanding']) ?></span></p></td>
            ...
            <div class="section" id="paging-wp">
                ...
                <?php  echo get_paging($num_page, $page, "?mod=product&action=list"); ?>
                </div>
            </div>
        </div>
    </div>
