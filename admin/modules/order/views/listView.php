        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form method="POST" action="?mod=order&action=list" class="form-s fl-right" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="?mod=order&action=delete&id=<?php echo $item['customer_id']?>&page=<?php echo $page ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
            ...
            <div class="section" id="paging-wp" style="margin-top: 20px">
                <div class="section-detail clearfix">
                   ...
                   <?php echo get_paging($num_page, $page, "?mod=order&action=list") ?> 
                </div>
            </div>
            <?php } ?>
        </div>
